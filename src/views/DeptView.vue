<template>
  ...
  <el-table :data="tableData" style="width: 100%" v-loading="loading" >
    ...
    <el-table-column prop="email" label="负责人邮箱" width="150"/>
...
<!-- ---------------------------弹窗 ------------------------------------------------------------>
<el-dialog v-model="dialogFormVisible" :title="DeptFrom.deptId?'编辑部门': '新增部门'"  destroy-on-close width="30%" :align-center="true" :center="true" >
