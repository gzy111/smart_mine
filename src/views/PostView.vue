...
<!-- ---------------------------弹窗 ------------------------------------------------------------>
<el-dialog v-model="dialogFormVisible" :title="PostFrom.postId?'编辑岗位': '新增岗位'"  destroy-on-close width="30%" :align-center="true" :center="true" >
